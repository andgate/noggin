...
export const generateQuestion = createServerFn<"POST", GenerateQuestionOptions, GeneratedQuestion>(
    "POST",
    async ({ sources, questions, questionTypes, controller }) => {
...
export const generateQuizTitle = createServerFn<"POST", GenerateQuizTitleOptions, string>(
    "POST",
    async ({ sources, questions, controller }) => {
