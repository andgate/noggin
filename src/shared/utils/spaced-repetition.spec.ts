...
describe('spaced-repetition', () => {
  ...
  describe('updateModuleStats', () => {
    ...
    it('should move to the next box and update nextReviewDate when passed', () => {
      ...
      expect(new Date(updatedStats.nextReviewDate).toISOString().split('T')[0]).toBe('2023-01-22')
    })
    ...
    it('should not exceed box 5 and update nextReviewDate when passed', () => {
      ...
      expect(new Date(updatedStats.nextReviewDate).toISOString().split('T')[0]).toBe('2023-02-14')
    })
    ...
    it('should reset to box 1 and update nextReviewDate when failed', () => {
      ...
      expect(new Date(updatedStats.nextReviewDate).toISOString().split('T')[0]).toBe('2023-01-16')
    })
