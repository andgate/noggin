import { Response } from '@/core/types/response.types'
...
export type CreateResponseInput = Pick<
  ...
  'question_id' | 'student_answer_text'
>

/**
 * Defines the data allowed for updating a submission (grading).
 */
export type UpdateSubmissionInput = Pick<
 ...
 */
export type UpdateResponseInput = Pick<TablesUpdate<'responses'>, 'feedback' | 'is_correct'>
