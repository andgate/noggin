...
import type { TablesInsert, TablesUpdate } from '@/shared/types/database.types' // Import needed helpers
import { mapDbQuestionToQuestion } from './questionApi.mappers'
import { mapDbQuizToQuiz } from './quizApi.mappers'

// --- Define Input Types Locally ---

// Input type for creating a new quiz
export type CreateQuizInput = Pick<TablesInsert<'quizzes'>, 'title' | 'time_limit_seconds'>

// Input type for creating new questions (omit fields auto-filled by API)
...
export type UpdateQuizInput = Pick<TablesUpdate<'quizzes'>, 'title' | 'time_limit_seconds'>

// Input type for updating an existing question
// Using TablesUpdate directly as the API function handles removing protected fields.
export type UpdateQuestionInput = TablesUpdate<'questions'>
...
export const createQuiz = async (
  moduleId: string,
  quizData: CreateQuizInput // Use locally defined type
): Promise<Quiz | null> => {
  const {
    data: { session },
    error: authError,
...
export const createQuestions = async (
  quizId: string,
  questionsData: CreateQuestionInput[] // Use locally defined type
...
export const updateQuiz = async (
  quizId: string,
  updates: Partial<UpdateQuizInput> // Use locally defined type (Partial allows subset)
): Promise<Quiz | null> => {
...
export const updateQuestion = async (
  questionId: string,
  updates: UpdateQuestionInput // Use locally defined type
): Promise<Question | null> => {
